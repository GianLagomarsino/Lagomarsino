...
<body background="./../../../img/backgrounds/aqua.jpg"> 
           <form method="post" class="form-horizontal well" name="contact" action="listar_productosNombre_agotados.php" style="border-right-width: 100px; margin-left: 0px; border-top-width: 100px; border-left-width: 100px;"onSubmit='return Validar(this);'>
                          <div class="cleaner"></div>  
						  
						  <h2 style="color:white;">Listado De Productos Agotados</h2>
       ...
       <table  width="100%" border="1" cellpadding="0" cellspacing="0">
        ...
        <th>Eliminar</th>
                    ...
                    <tbody>
					 ...
					 $result = $base_datos->sql_query($producto->listarProductos2());
		 ...
		 echo "<td>";
			 ...
			 echo "</td>";
		   	 echo "<th><a href='agregar_producto.php?producto_id=".$producto_id."'><img src='../../images/agregar.png'></th>";   		 	 						 echo "<th><a href='eliminar_producto.php?producto_id=".$producto_id."'onclick='return confirmar()'><img src='../../images/delete.png'></a></th>";				 
	 ...
	 ?>
					 ...
					 $result = $base_datos->sql_query($producto->contarProductosSinStock());
						 while($row = $base_datos->sql_fetch_assoc($result)) {
					  ...
					  $number 			= $row['number'];
 								...
 								echo "<tr align='right' class = 'light'>";
								   echo "<td colspan='7'>Cantidad De Productos</td>";
								echo "<td>";							
								 echo $number;
								echo "</td>";  
								echo "</tr>";            
