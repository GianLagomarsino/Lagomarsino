...
{ 
   ...
   if ( letra == null || letra =="") 
  {
 	alert("Debe ingresar cantidad repuestos");
 ...
 var letra = formulario.fecha_pago.value;
  ...
  var letra = formulario.titular_cheque.value;
   if ( letra == null || letra =="") 
  {
 	alert("Debe ingresar un Titular Cheque");
  	formulario.titular_cheque.focus();
	return false;
  } 


	
   var letra = formulario.serie_cheque.value;
   if ( letra == null || letra =="") 
  {
 	alert("Debe ingresar el numero de serie del cheque");
  	formulario.serie_cheque.focus();
	return false;
  } 	

   var letra = formulario.nombre_banco.value;
   if ( letra == null || letra =="") 
  {
 	alert("Debe ingresar el nombre del banco");
  	formulario.nombre_banco.focus();
	return false;
  } 	
	
   
   
   var letra = formulario.cuota.value;
   if ( letra == null || letra =="") 
  {
...
<form class="form-horizontal well" name="form" id="form" onSubmit="return Validar(this);" method="post" style="border-right-width: 98px; margin-left: 0px; border-left-width: 98px; border-top-width: 98px;" action="repuestos_vendido2.php?producto_id=".$producto_id."">
...
<table>
 ...
 <tr class="dark">
  ...
  <tr class="dark">
            ...
            <td><span class="label label-primary" for="input02">Fecha Ingreso</span></td>
              ...
              <td><span class="label label-primary" for="input04">Serie Cheque</span></td>
 ...
 <tr class="dark">
            <td><span class="label label-primary" for="input02">Precio</span></td>
              ...
              <td><span class="label label-primary" for="input04">Nombre Banco</span></td>
            ...
            <td><span class="label label-primary" for="input02">Cantidad total</span></td>
              ...
              <td><span class="label label-primary" for="input04">Cantidad Cuotas</span></td>
  ...
  <input class="input-xlarge"  id="fecha_modificacion" name="fecha_modificacion" readonly="readonly" type="hidden" value="<?php echo date("Y-m-d")?>" onblur="return validar(event);" />
          ...
          <input class="input-xlarge"  id="cantidad_abono" name="cantidad_abono" type="hidden" readonly="" value="0" onblur="return validar(event);" />
