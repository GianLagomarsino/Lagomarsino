...
<form class="form-horizontal well" method="post" id="FormularioExportacion"  style="border-right-width: 100px; margin-left: 0px; margin-top: 0px; border-left-width: 100px; border-top-width: 110px; height: 100%;" target="_blank" action="../../functions/reporteClienteJuridico.php">
      ...
      <input readonly="readonly" type="hidden" id="cliente_id" name="cliente_id" size="20" value="<?php echo $cliente_id?>">
		...
		<th>Sucursal Asociada</th>		
                    ...
                    <tbody>
					 ...
					 $result = $base_datos->sql_query($cliente->listarClientesxServiciosJuridicos2($cliente_id));
						 while($row = $base_datos->sql_fetch_assoc($result)) {
           ...
           ?>
                <?php 
					 ...
					 $result = $base_datos->sql_query($cliente->contarClientesxServiciosJuridicos2($cliente_id));
						 while($row = $base_datos->sql_fetch_assoc($result)) {
