...
<form id="form" class="form-horizontal well" style="border-right-width: 98px; margin-left: 0px; border-left-width: 98px; border-top-width: 98px;" name="form" action="venta_asociada.php" method="post" onSubmit='return Validar(this);'>
        <fieldset>
