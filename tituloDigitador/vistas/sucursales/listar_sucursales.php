...
<body background="./../../../img/backgrounds/aqua.jpg">  
 <form  class="form-horizontal well" method="post" action="listar_sucursalesNombre.php" style="border-right-width: 100px; margin-left: 0px; border-top-width: 100px; border-left-width: 100px;"onSubmit='return Validar(this);'>
		...
		<thead>
       	...
       	<tr>
        <th width="8%">RUT</th>	
		<th width="12%">Nombre Sucursal</th>		
		<th width="19%">Nombre Encargado </th>
	    
        <th width="18%">Direccion Sucursal</th>
        ...
        <th width="9%">Eliminar</th>
                    ...
                    <tbody>
					 ...
					 $result = $base_datos->sql_query($sucursal->listarSucursales());
	 ...
	 ?>
					 ...
					 $result = $base_datos->sql_query($sucursal->contarSucursales());
						 while($row = $base_datos->sql_fetch_assoc($result)) {
					  ...
					  $number 			= $row['number'];
 								...
 								echo "<tr align='right' class = 'light'>";
								  echo "<td colspan='9'>Cantidad total de sucursales</td>";
								echo "<td>";							
								echo $number;
								echo "</td>";  
								echo "</tr>";            
