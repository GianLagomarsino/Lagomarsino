...
<body background="./../../../img/backgrounds/aqua.jpg"> 
 <form class="form-horizontal well" method="post" name="contact" onSubmit='return Validar(this);'  action="listar_pagosFechas2.php" style="border-right-width: 100px; margin-left: 0px; border-top-width: 100px; border-left-width: 110px;">
                          <div class="cleaner"></div>
                          
                   <h2 style="color:white">Listado de todos los pagos</h2>
	...
	<p><span class="label label-primary" for="input02">Buscar Pagos fecha creacion entre</span> <input readonly="readonly" type="text" id="fecha_inicio1" name="fecha_inicio1" size="20" value="" onBlur="return validar(event);"> <span class="label label-primary" for="input02"> Y</span>  <input readonly="readonly" type="text" id="fecha_inicio2" name="fecha_inicio2" size="20" value="" onBlur="return Validar(event);">
		...
		<?php 
		  ...
		  ?>					  
					 ...
					 $result = $base_datos->sql_query($pago->listarPagosFecha2($fecha_inicio1, $fecha_inicio2));
	        ...
	        echo "<th><a href='detalles_pagos.php?pagos_id=".$pagos_id."'>".$nombre_producto."</a></th>";
			...
			echo "</td>";	
  		    echo "<th><a href='repuesto_pendiente.php?pagos_id=".$pagos_id."'><img src='../../images/edit.png'></th>";  
			 //echo "<td>".$telefono."</td>";	
  		 	 //echo "<td>".$celular."</td>";
		     //echo "<td>".$sueldo."</td>";	
	 ...
	 ?>
                    ...
                    <?php 
					 ...
					 $result = $base_datos->sql_query($pago->contarPagosPagadosFecha($fecha_inicio1, $fecha_inicio2));
						 while($row = $base_datos->sql_fetch_assoc($result)) {
					  ...
					  $number 			= $row['number'];
		  				 ...
		  				 echo "<td colspan='9'>Cantidad total de productos pagados en relacion al rango seleccionado</td>";
						 echo "<td>";
 						 echo $number;
						 echo "</td>";
  						 echo "</tr>";            
	 ?>       
               ...
               <?php 
					 ...
					 $result = $base_datos->sql_query($pago->sumarPagosPagadosFecha($fecha_inicio1, $fecha_inicio2));
						 while($row = $base_datos->sql_fetch_assoc($result)) {
					  ...
					  $number 			= $row['number'];
 								...
 								echo "<tr align='right' class = 'light'>";
								echo "<td colspan='9'>Remuneracion de pagos en relacion al rango seleccionado </td>";
								echo "<td>";							
