...
<body background="./../../../img/backgrounds/aqua.jpg"> 
 <form class="form-horizontal well" method="post" id="form" name="form" action="listar_serviciosNombre_terminados.php" onSubmit='return Validar(this);' style="border-right-width: 100px; margin-left: 0px; border-top-width: 100px; border-left-width: 100px;">
		...
		<p><span class="label label-primary" for="input02">Buscar Servicios fecha inicio entre</span> <input readonly="readonly" type="text" id="fecha_inicio1" name="fecha_inicio1" size="20" value="" onBlur="return validar(event);"> <span class="label label-primary" for="input02"> Y</span>  <input readonly="readonly" type="text" id="fecha_inicio2" name="fecha_inicio2" size="20" value="" onBlur="return Validar(event);">
		...
		<?php 
		  ...
		  ?>		
					   ...
					   $fecha_inicio1 = $_POST['fecha_inicio1'];
					   $fecha_inicio2 = $_POST['fecha_inicio2'];
					 $result = $base_datos->sql_query($servicio->listarServiciosFecha($fecha_inicio1 , $fecha_inicio2));
	 ...
	 ?>
              ...
              <?php 
					 ...
					 $result = $base_datos->sql_query($servicio->contarServiciosFinalizadosFecha($fecha_inicio1, $fecha_inicio2));
						 while($row = $base_datos->sql_fetch_assoc($result)) {
					  ...
					  $number 			= $row['number'];
								...
								echo "<td colspan='9'>Cantidad total de servicios inactivos en relacion al rango buscado</td>";
