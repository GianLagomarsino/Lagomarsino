...
<form id="form" class="form-horizontal well" style="border-right-width: 98px; margin-left: 0px; border-left-width: 98px; border-top-width: 98px;" onsubmit="return Validar(this);" name="form" action="pago_asociado.php" method="post">
        <fieldset>
          <h2 style="color:white">Ingresar Pago De Productos</h2>
          <table>
           
<?PHP						
					 	$pago_proveedores_id = $_POST['pago_proveedores_id'];
...
and  pago_proveedores.pago_proveedores_id = ".$_POST['pago_proveedores_id'].";");
       ...
       <input class="input-xlarge" id="fecha_modificacion" name="fecha_modificacion" readonly="readonly" type="hidden" value="<?php echo date("Y-m-d")?>">    
       <input class="input-xlarge" readonly="readonly" id="estado" name="estado" value="1" type="hidden" > 
       <input class="input-xlarge" readonly="readonly" id="deuda" name="deuda"   value="0" type="hidden" >
       <input class="input-xlarge" readonly="readonly" id="pago_proveedores_id" name="pago_proveedores_id" type="hidden" value="<?php echo $pago_proveedores_id?>"  /> 
          ...
          <div class="form-actions">
            ...
            <button type="reset" class="btn" onclick = "javascript:window.location='listar_pagos.php'">Cancelar</button>
  </div>
        </fieldset>
</form>
