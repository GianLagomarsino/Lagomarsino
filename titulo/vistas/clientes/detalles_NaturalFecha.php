      ...
      <input readonly="readonly" type="hidden" id="cliente_id" name="cliente_id" size="20" value="<?php echo $cliente_id?>">
		...
		<th>Sucursal Asociada</th>		
                    ...
                    <tbody>
					 ...
					 $result4 = $base_datos->sql_query($cliente->listarClientesxServiciosNaturales2Fecha($cliente_id, $fecha_inicio1, $fecha_inicio2));
						 while($row = $base_datos->sql_fetch_assoc($result4)) {
           ...
           <?php 
					 ...
					 $result = $base_datos->sql_query($cliente->contarClientesxServiciosNaturales2Fecha($cliente_id, $fecha_inicio1, $fecha_inicio2));
						 while($row = $base_datos->sql_fetch_assoc($result)) {
