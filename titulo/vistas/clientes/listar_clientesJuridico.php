  ...
  <div id="templatemo_content">
        ...
        <th>Eliminar</th>
                    ...
                    <tbody>
					 ...
					 $result = $base_datos->sql_query($juridico->listarClientesJuridicos());
		...
		//	 $tabla .="<td><p>".$fecha_modificacion."</p></td>";
  		//     $tabla .="<td><p>".$estado."</p></td>";			 
			...
			echo "<th><a href='eliminar_clienteJuridico.php?cliente_id=".$cliente_id."'onclick='return confirmar()'><img src='../../images/delete.png'></a></th>";				 
	 ...
	 ?>
                 ...
                 <?php 
					 ...
					 $result = $base_datos->sql_query($cliente->contarClientesJuridicos());
						 while($row = $base_datos->sql_fetch_assoc($result)) {
