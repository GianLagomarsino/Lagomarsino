 ...
 <div id="sign_in1">
        <div class="container">
            <div class="row">
				    ...
				    <h6 style="
   font-size:150%; color:#fff;  padding-top: 110px;
">
					Este sistema esta dise&ntilde;ado por la necesidad de digitalizar los procesos de la empresa Laboratorio Diesel Lagomarsino
					</h6>
                    <p>
                       <p><img src="../../../img/slides/scene1/macbook.png">              	
                       <p>&nbsp;</p>
<p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>
            ...
            <div class="row info">
                <div class="col-sm-6 residence">
                    <ul>
                        ...
                        <li><strong>Direccion : </strong>Gran Breta&ntilde;a 281</li>
