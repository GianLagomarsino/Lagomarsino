...
<form id="form" class="form-horizontal well" style="border-right-width: 98px; margin-left: 0px; border-left-width: 98px; border-top-width: 98px;" onsubmit="return validar(this);" name="form" action="tarea_ingresada.php" method="post">
        <fieldset>
          <h2 style="color:white;">Ingresar Tareas</h2>
  ...
  <table width="200" border="0">                
            ...
            <td><span class="label label-primary" for="input01">Nombre Tarea</span>
           <td> <input class="input-xlarge" id="nombre_tarea" name="nombre_tarea"   type="text" onBlur="return validar(event);"></td>
            ...
            <td><span class="label label-primary" for="input03">Valor</span></td>
