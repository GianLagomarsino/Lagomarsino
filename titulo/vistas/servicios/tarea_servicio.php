...
<form class="form-horizontal well" name="form" id="form" onSubmit="return validar(this);" method="post" style="border-right-width: 98px; margin-left: 0px; border-left-width: 98px; border-top-width: 98px;" action="tarea_asociada.php?servicio_id=".$servicio_id."">
...
AND servicios.servicio_id = $servicio_id");
        ...
        <fieldset>
          ...
          <input class="input-xlarge" id="servicio_id" name="servicio_id"  readonly="readonly"  type="hidden" onBlur="return validar(event);"value="<?PHP echo $servicio_id; ?>">
            ...
            <td width="72"><span class="label label-primary" for="input01">Nombre Servicio</span></td>
            
             <td width="144"> <input class="input-xlarge" id="nombre_servicio" name="nombre_servicio"  readonly="readonly"  type="text" onBlur="return validar(event);"value="<?PHP echo $nombre_servicio; ?>"></td>
...
<input class="input-xlarge" id="estado_servicio" name="estado_servicio" readonly="readonly"  type="hidden" onBlur="return validar(event);"value="<?PHP echo $estado_servicio; ?>">
 ...
 <tr class="dark"> 
            <td><span class="label label-primary" for="input03">Nombre Tarea</span></td>
            
              <td>	<input class="input-xlarge" id="nombre_tarea" name="nombre_tarea"   type="text" onBlur="return validar(event);">
              </td> </tr> 

 <tr class="dark"> 
            <td><span class="label label-primary" for="input03">Valor Tarea</span></td>
            
              <td>	<input class="input-xlarge" id="valor" name="valor"   type="text" onBlur="return validar(event);">
              </td> 
              </tr> 
          ...
          <div class="form-actions">
            ...
            <td><button type="reset" class="btn"  value=Atr&aacute;s onclick = "javascript:window.location='listar_servicios.php'"">Cancelar</button></td>
          </tr>
          </div>
        </table>
        </fieldset>
