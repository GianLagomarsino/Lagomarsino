...
<body background="./../../../img/backgrounds/aqua.jpg"> 
           <form method="post" class="form-horizontal well" name="contact" action="listar_productosNombre_agotados.php" onSubmit='return Validar(this);' style="border-right-width: 100px; margin-left: 0px; border-top-width: 100px; border-left-width: 100px;" onSubmit='return Validar(this);'>
       ...
       <table  width="100%" border="1" cellpadding="0" cellspacing="0">
        ...
        <th>Eliminar</th>
		  ...
		  ?>
					 ...
					 $result = $base_datos->sql_query($producto->listarProductosName2($nombre_buscado));
		 ...
		 echo "<td>";
			 ...
			 echo "</td>";
		   	 echo "<th><a href='agregar_producto.php?producto_id=".$producto_id."'><img src='../../images/agregar.png'></th>"; 
	 ...
	 ?>
					 ...
					 $result = $base_datos->sql_query($producto->contarProductosSinStockNombre($nombre_buscado));
						 while($row = $base_datos->sql_fetch_assoc($result)) {
					  ...
					  $number 			= $row['number'];
								 ...
								 echo "<td colspan='7'>Cantidad de productos en relacion al ranngo seleccionado</td>";
								echo "<td>";							
								 echo $number;
								echo "</td>";  
								echo "</tr>";            
