...
<form class="form-horizontal well" method="post" action="ingresar_ventas_cheque.php" name="formulario" id="formulario" onClick="return validar(this);" style="border-right-width: 98px; margin-left: 0px; border-left-width: 98px; border-top-width: 98px;"/>
