...
<form class="form-horizontal well" method="post" name="contact" action="listar_proveedoresNombre.php" onSubmit='return Validar(this);' style="border-right-width: 100px; margin-left: 0px; border-top-width: 100px; border-left-width: 100px;">
        ...
        <th>Eliminar</th>
                    ...
                    <tbody>
					 ...
					 $result = $base_datos->sql_query($proveedor->listarProveedores());
	 ...
	 ?>
              ...
              <?php 
					 ...
					 $result = $base_datos->sql_query($proveedor->contarProveedores());
						 while($row = $base_datos->sql_fetch_assoc($result)) {
 ...
 echo "<td colspan='7'>Total Proveedores</td>";
 echo "<td>";
 echo $number;
 echo "</td>";
